"""Tests for A7 (S5L8965X / T7002) checkm8 exploit stub."""

from __future__ import annotations

import pytest

from ipwndfu_py312.exploits.a7 import EXPLOIT
...
class TestA7Exploit:
    ...
    def test_run_returns_payload_pending(self):
        device = UsbDeviceInfo(0x05AC, 0x1227, "Apple", "DFU", serial="CPID:8965")
        result = EXPLOIT.run(session_from_device(device))
        assert result.soc == "a7"
