"""Tests for A9 (S8000 / S8001 / S8003) checkm8 exploit stub."""

from __future__ import annotations

import pytest

from ipwndfu_py312.exploits.a9 import EXPLOIT
...
class TestA9Exploit:
    ...
    def test_run_returns_payload_pending(self):
        device = UsbDeviceInfo(0x05AC, 0x1227, "Apple", "DFU", serial="CPID:8003")
        result = EXPLOIT.run(session_from_device(device))
        assert result.soc == "a9"
