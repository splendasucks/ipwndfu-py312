"""Tests for A11 (T8015) checkm8 exploit stub."""

from __future__ import annotations

import pytest

from ipwndfu_py312.exploits.a11 import EXPLOIT
...
class TestA11Exploit:
    @pytest.mark.unit
    def test_run_returns_payload_pending(self):
        device = UsbDeviceInfo(0x05AC, 0x1227, "Apple", "DFU", serial="CPID:8015")
